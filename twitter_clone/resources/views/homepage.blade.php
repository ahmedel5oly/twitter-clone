...
{{-- second pass name contain confirmation to make it easy for laravel to check it out --}}
            <div class="form-group"> 
            ...
            <button type="submit" class="py-3 mt-4 btn btn-lg btn-success btn-block">Sign up for Twitter_Clone</button>
          </form>
        </div>
      </div>
    </div>
